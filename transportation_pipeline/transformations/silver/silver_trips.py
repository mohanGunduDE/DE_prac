...
def func():
    df_bronze = spark.readStream.table("transportation.bronze.trip")
    ...
    df_silver = df_bronze.select(
        ...
        F.col("ingest_time").alias("bronze_ingest_timestamp"),
    )
...
dp.create_streaming_table(
    name = "transportation.silver.trip",
...
# transportation.silver.trip destination
# trips_silver_staging source

dp.create_auto_cdc_flow(
    target = "transportation.silver.trip",
